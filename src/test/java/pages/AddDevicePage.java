...
public class AddDevicePage extends GenericWrappers {
	...
	public String RouterRemovedSuccessfully = loadProp("RouterRemovedSuccessfully");
 ...
 @FindBy(xpath = "//*[@resource-id='SignIn_SignInText']")
	...
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc=\"Bajaj\"]")
	private WebElement ACBrandNameBajaj;
	...
	private WebElement hourstextboxplus;
	...
	private WebElement minutestextboxplus;
...
//	private WebElement exitPairingok_popup;
	...
	@FindBy(xpath = "//android.widget.Toast[@text=\"Router removed successfully\"]")
	private WebElement routerremovedsuccessfullytoast;
	...
	@FindBy(xpath = "//*[@resource-id='TimeLeft_Bottom_Line']")
	private WebElement timeLeftBottomLine;
	@FindBy(xpath = "//android.widget.TextView[@text=\"Note : Please Don't lock or put your mobile in the background while pairing\"]")
	private WebElement verifyingSmazerContent;
	@FindBy(xpath = "//android.widget.TextView[@text=\"Verifying  SmaZer...\"]")
	private WebElement verifyingSmazer;
	...
	public void verifyDefaultCapacity() {
		
		verifyTextContainsByXpath(enterCapacity, "8", "AC capacity value");
	}
	...
	{
	if (isElementDisplayedCheck(ACBrandNameClick)) {
		clickbyXpath(ACBrandNameClick, "Acbrandname");
		clickbyXpath(ACBrandNameBajaj, "Acbrandname");
		
	}else if (isElementDisplayedCheck(ACBrandNameBajaj)) {
		verifyTextContainsByXpath(ACBrandNameBajaj,"Bajaj" , "AC brand name bajaj");
		System.out.println("Bajaj name displayed");
	}
	}
...
//	}
	...
	public void Hourstextboxplus(String value) {
		verifyTextContainsByXpath(hourstextboxplus, value, "Hours");
	}
	
	public void Minutestextboxplus(String value) {
		verifyTextContainsByXpath(minutestextboxplus,value , "Minutes");
	}
...
//			clickbyXpath(alertpopup, "alertokpop-up");
			fail(new Exception("Unregistered device detected "));
		} else {
			System.out.println("Unregistered pop-up not displayed proceeding to next step");
		}
	}
...
//				"Device settings updated successfully! toast");
	...
	public void verificationFailed() {
		...
		if (isElementDisplayedCheck(verificationFailed)) {
			fail(new Exception("Verification failed pop-up"));
		}else {
			System.out.println("Verification failed pop-up not displayed proceeding to next step");
		}
//		verifyTextContainsByXpath(verificationFailed, "Verification failed", "Verificationfailed");
//		clickbyXpath(alertok, "Verfication failed");
	}
