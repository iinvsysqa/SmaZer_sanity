...
public class DeviceMenuPage extends GenericWrappers{
	...
	@FindBy(xpath = "//android.widget.TextView[@text=\"Device Settings\"]")
	...
	@FindBy(xpath ="//android.widget.TextView[@text=\"SmaZer Info\"]")
	...
	@FindBy(xpath = "//android.widget.TextView[@text=\"Bajaj\"]")
...
//	@FindBy(xpath = "//android.widget.TextView[@text=\"Remove Device\"]")
//	private WebElement removeDevice;
	...
	@FindBy(xpath = "//*[@resource-id='InfinitePowerOn_Toggle']")
...
//	private WebElement defaultHr_Devicesettings;
	...
	public void CheckSzephyrInfPageBrandName() {
		...
		verifyTextContainsByXpath( CheckSzephyrInfPageBrandName, "Bajaj", "AC Brand Name");
    }
	...
	public void CheckSzephyrInfPageCapacity() {
		...
		verifyTextContainsByXpath( CheckSzephyrInfPageCapacity, "8", "Capacity");
    }
...
//		============================
		...
		public void checkrouterremovedsuccessfultoast() {
			expshortWait(routerremovedsuccessfullytoast);
...
//			clickbyXpath(DurationforOnToggle, "Toggle switch");
		...
		private void clickdurationforOnToggle() {
			clickbyXpath(DurationforOnToggle, "Toggle switch");
